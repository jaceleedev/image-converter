use crate::{
    ...
    input::{is_supported_input_extension, register_extra_decoders},
    ConversionOptions, ConvertStats, JpegBackground, OutputFormat,
};
use axum::{
    body::Body,
...
impl ApiError {
    ...
    fn conversion(error: crate::ConverterError) -> Self {
        match error {
